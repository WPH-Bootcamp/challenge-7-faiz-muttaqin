            ...
            {position === 'left' ? (
                <>
                    <div className="order-3 flex-grow md:order-1 md:w-1/2 text-right animate-on-scroll fade-left" style={{ animationDelay: `${delay}ms` }}>
                        <div
                            ref={ref}
                            className={`flex bg-white dark:bg-gray-900/40 border border-gray-200 dark:border-gray-900 rounded-xl p-6 relative group hover:border-orange-500 transition-all duration-300 ${
